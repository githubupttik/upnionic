...
(function (factory) {
    ...
    var PopoverPopIn = (function (_super) {
        ...
        PopoverPopIn.prototype.init = function () {
            ...
            var /** @type {?} */ wrapper = new animation_1.Animation(this.plt, ele.querySelector('.popover-wrapper'));
    ...
    var PopoverMdPopIn = (function (_super) {
        ...
        PopoverMdPopIn.prototype.init = function () {
            var /** @type {?} */ ele = this.enteringView.pageRef().nativeElement;
            var /** @type {?} */ content = new animation_1.Animation(this.plt, ele.querySelector('.popover-content'));
            var /** @type {?} */ viewport = new animation_1.Animation(this.plt, ele.querySelector('.popover-viewport'));
